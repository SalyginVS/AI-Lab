...
| **NL-to-SQL** | Text-to-SQL PoC: SA 75–90% (✅ 11A) | + Semantic layer (Vanna) + retrieval-based prompt | + Production pipeline + multi-DB + guardrails |
...
| 23 | Prompt bleed mitigation: retrieval-based vs monolithic prompt для NL-to-SQL | [A] Monolithic prompt bleed подтверждён в 11A (Грабли #36) | Среднее | При проектировании production NL-to-SQL |
