...
**Паспорт стенда:** v26.0 (2026-04-08)
...
Ключевой принцип: **не заменять, а достраивать**. Всё, что подтверждено тестами в этапах 1–16, 13, остаётся. Новые компоненты добавляются поверх существующего фундамента.
...
| L1 — Canonical | Official architecture decisions (ADR-008…016) | 7 | Primary index |
...
| 12 | MCP: Docker | 14 (security boundary) | ⬜ **Следующий** | 1 спринт |
| F-next | Semantic Layer: retrieval-assisted SQL | 11A, 11 | ⬜ Planned | 2–3 спринта |

```
Параллельные треки (обновлено v1.12):

Трек A (MCP Tools):          8A✅→ 8B✅ → 11✅ ──────→ 12 ◄── СЛЕДУЮЩИЙ
Трек B (Backend):            9A✅→ 9B✅   10A✅→ 10B✅  10C✅→ 10D✅
Трек C (Knowledge):          ──────────────────────────→ 13✅
Трек D (Ops/Security):       ───── 15✅ → 14✅
Трек E (Orchestration):      8C✅→ 8D✅ ────────→ 16✅
Трек F (AI-as-Interface):    11A✅ → 11✅ → [Semantic Layer]

Приоритетный порядок следующих этапов: 12 → F-next
```
...
| **Onboarding** | Паспорт лаборатории (✅ v26) | **ONBOARDING.md + setup-check.sh/ps1 (✅ 13)** | Полный onboarding пакет < 30 мин |
